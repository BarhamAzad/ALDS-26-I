...
class DepthEstimator:
    ...
    def __init__(self, model_type: str = "base", device: str = "cuda"):
        """
    ...
    def _initialize_model(self):
        """Initialize Depth Anything V2 model from Hugging Face"""
        try:
            device_idx = 0 if self.device == "cuda" and torch.cuda.is_available() else -1
            model_name = f"depth-anything/Depth-Anything-V2-{self.model_type}-hf"
